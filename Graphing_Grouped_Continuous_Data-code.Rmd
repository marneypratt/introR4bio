...
ggsave("bar.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
# A histogram is only useful when there are enough data points.  
# A good rule of thumb is that a histogram is useful when your sample size in each group is 20-30 or more.  
# If your N < 20 for each group, then it may not be useful to visualize with a histogram. 
...
ggsave("histogram.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
ggsave("box.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
#This code will give a box plot with the mean indicated with an X (erase the stat_summary function if you want to remove the mean)
#All points are included and randomly jittered to avoid overlapping
...
ggsave("box_random.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
#This code will give a box plot with the mean indicated with an X (erase the stat_summary function if you want to remove the mean)
#All points are included and symmetrically jittered using beeswarm to avoid overlapping
...
ggsave("box_beeswarm.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
#This code will give a box plot with the mean indicated with an X (erase the stat_summary function if you want to remove the mean)
#All points are included and symmetrically jittered using quasirandom to avoid overlapping
...
ggsave("box_quasi.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
ggsave("violin.jpg", height = 7, width = 8, units = "in", dpi = 500)

```

# Dot Plots

An increasingly popular way of visualizing data when the sample size is small enough is to show all the points and a measure of central tendency.  Below are three options for how to add points (1) random jitter, (2) beeswarm, (3) quasirandom.  These examples all use the mean, to make graphs with the median, just replace the word mean with median everywhere in the graph.
...
ggsave("dot.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
ggsave("dot_beeswarm.jpg", height = 7, width = 8, units = "in", dpi = 500)
...
ggsave("dot_quasi.jpg", height = 7, width = 8, units = "in", dpi = 500)
